    ...
    render() {
        return (
            ...
            <footer className="footer">
                ...
                <li> <a className="footer__text" href="index.html">Home</a> </li>

                <li> <a className="footer__text" href="products.html">Products</a></li>

                <li> <a className="footer__text" href="contact.html">Contact Us</a></li>
